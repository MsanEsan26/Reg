...
if(!['804311061163147275'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '⚝'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '804311061116616803') 
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '804311061091188745')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '804311061091188736')
const genelchat = message.guild.channels.cache.find(c => c.id === '804311062832087112')
const savelog = message.guild.channels.cache.find(c => c.id === '804311061200502791')
