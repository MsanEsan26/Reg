...
if(!['804311061138374714'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
await member.roles.add('804311061091188736')
